        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button
              ...
              className="bg-purple hover:bg-hoverPurple mt-2 w-36"
            >
              Search
            </Button>
          </div>
                  ...
                  >
                    ...
                    <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                      <Link to={`/restaurant/${restaurant._id}`}>
                        <Button className="bg-purple hover:bg-hoverPurple font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200">
                          View Menus
                        </Button>
                      </Link>
                    </CardFooter>
