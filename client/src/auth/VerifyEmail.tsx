...
const VerifyEmail = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen w-full">
       <div className="p-8 rounded-md w-full max-w-md flex flex-col gap-10 border-gray-300">
          ...
          <form onSubmit={submitHandler}>
            ...
            </div>
            {
              loading ? 
              (
              <Button className="bg-purple hover:bg-hoverPurple mt-6 w-full " disabled>
                <Loader2 className="animate-spin mr-2 w-4 h-4"/>Please wait
                </Button>
             ) : (
                <Button className="bg-purple hover:bg-hoverPurple mt-6 w-full">Verify
                </Button>
              )
            }
          </form>
